  ...
  if (sent) {
    return (
      <div className="w-full max-w-[400px]">
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-dialog)] p-8 text-center">
          <Mail size={32} className="mx-auto mb-4 text-[var(--primary)]" />
  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-dialog)] p-7">
        ...
        <p className="text-[13px] text-[var(--muted)] mb-6">Sign in to your account</p>
        ...
        <button onClick={handleGoogle} disabled={loading}
          className="w-full flex items-center justify-center gap-2.5 py-2.5 border border-[var(--border)] rounded-[var(--r-btn)] text-[13px] font-medium hover:bg-[var(--bg)] transition-colors disabled:opacity-50">
