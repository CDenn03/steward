    ...
    <div className="w-full max-w-[420px]">
      ...
      <div className="bg-(--surface) border border-(--border) rounded-[var(--r-dialog)] p-7">
        ...
        <div className="flex items-center gap-3 bg-[var(--primary-light)] rounded-[10px] p-3.5 mb-6">
          <div className="w-9 h-9 rounded-full bg-(--primary) flex items-center justify-center text-white text-[13px] font-semibold flex-shrink-0">GC</div>
          <div>
            <p className="text-[13px] font-medium">Grace Community Church</p>
            <p className="text-[11px] text-(--muted)">Invited by James Mwangi · Finance Officer</p>
          </div>
        ...
        <p className="text-[13px] text-(--muted) mb-6">You&apos;re joining as a <strong>Department Head</strong></p>
        ...
        <div className="space-y-3.5">
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Sarah Kamau" className="w-full pl-8 pr-3 py-2.5 text-[13px] bg-(--surface) border border-(--border) rounded-(--r-input) outline-none focus:border-(--primary) text-[var(--text)] placeholder:text-(--muted) transition-colors" />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" defaultValue="sarah@gracecommunity.org" className="w-full pl-8 pr-3 py-2.5 text-[13px] bg-[var(--bg)] border border-(--border) rounded-(--r-input) outline-none text-(--muted) transition-colors cursor-not-allowed" readOnly />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" placeholder="At least 8 characters" className="w-full pl-8 pr-3 py-2.5 text-[13px] bg-(--surface) border border-(--border) rounded-(--r-input) outline-none focus:border-(--primary) text-[var(--text)] placeholder:text-(--muted) transition-colors" />
            </div>
          </div>
