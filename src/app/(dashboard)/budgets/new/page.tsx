...
import { mockDepartments, mockEvents } from "@/lib/mock/data";
...
const CATEGORIES = [
  ...
  "Printing & Stationery", "Communication", "Speaker Fees",
  "Contingency", "Other",
];
                ...
                <div key={item.id} className="grid grid-cols-[1fr_140px_80px_120px_100px_36px] gap-2 px-4 py-3 items-center hover:bg-[var(--bg)] transition-colors">
                  ...
                  <div>
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 text-[12.5px] bg-[var(--surface)] border border-[var(--border)] rounded-[8px] outline-none focus:border-[var(--primary)] text-[var(--text)] transition-colors text-right font-mono"
                    />
                  </div>
                  <div>
                    <input
