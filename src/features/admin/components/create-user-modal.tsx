...
type CreatePlatformUserInput = z.infer<
...
export function CreatePlatformUserModal({ open, onOpenChange, organizations, }: CreatePlatformUserModalProps) {
    ...
    async function onSubmit(
        values: CreatePlatformUserInput
    ) {
        try {
