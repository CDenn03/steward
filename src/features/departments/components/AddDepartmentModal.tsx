    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" role="dialog" aria-modal="true" aria-label="Add department">
      <div className="bg-(--surface) border border-(--border) rounded-(--r-card) shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-5 py-4 border-b border-(--border)">
          <div>
            <p className="text-[16px] font-semibold">Add Department</p>
            <p className="text-[13px] text-(--muted)">Create a new department</p>
          </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-[13px] font-medium mb-1.5">Department Name <span className="text-danger">*</span></label>
          ...
          <div>
            <label className="block text-[13px] font-medium mb-1.5">Department Head</label>
          ...
          <div>
            <label className="block text-[13px] font-medium mb-1.5">Annual Soft Limit <span className="text-(--muted) font-normal">(optional)</span></label>
            ...
            {softLimit > 0 && (
              <p className="text-[12px] text-(--muted) mt-1">Warning at {formatCurrency(softLimit)}</p>
            )}
          </div>
        </div>
